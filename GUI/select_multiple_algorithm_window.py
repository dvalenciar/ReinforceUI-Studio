...
class SelectMultipleAlgorithmWindow(BaseWindow):
    def __init__(self, welcome_window, user_selections) -> None:  # noqa
        """Initialize the SelectMultipleAlgorithmWindow class"""
        super().__init__("Select Algorithms", 900, 300)
        ...
        # Title label
        welcome_label = QLabel("Select Algorithms to Compare", self)
        ...
        hyperparam_label = QLabel(
            "Use the default hyperparameters?", self
        )
